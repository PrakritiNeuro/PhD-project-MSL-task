function [dest_rect] = ld_get_dest_rect(theTexture,screenSize, rectCenter)
%[dest_rect] = ld_get_dest_rect(theTexture,screenSize, rectCenter)
...
dest_rect = CenterRectOnPointd(img_rect, ...
